<?php
/*
Plugin Name: Post Comment Notification Twilio
Description: Plugin for admin sms notification on wordpress post comment
Version: 1.0.0
Author: Hamid Azad
...
if ( !function_exists( 'twilio_post_comment_maybe_create_table' ) ) { 
    require_once ABSPATH . '/wp-admin/install-helper.php'; 
} 


    function twilio_post_comment_maybe_create_table() {

    global $wpdb;
    $table_name= $wpdb->prefix."twilio_post_comment_notification";
...
register_activation_hook( __FILE__, 'twilio_post_comment_maybe_create_table' );

function comment_notification_settings_page()
{
    add_menu_page(
        ...
        'manage_options',
        'commentNotifier',
        'comment_notification_settings_markup',
        'dashicons-format-chat',
        100
    );

}
add_action( 'admin_menu', 'comment_notification_settings_page' );


function comment_notification_settings_markup()
{
...
function twilio_notification_comment_inserted() {
...
add_action( 'wp_insert_comment', 'twilio_notification_comment_inserted' );